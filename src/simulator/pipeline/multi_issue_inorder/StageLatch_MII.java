...
public class StageLatch_MII {
	...
	long instructionCompletesAt[]; // used to indicate when the corresponding
									// instruction is ready for
									// consumption by the next stage;
									// a long is used instead of a boolean
									// because a boolean would require
									// modeling the completion of execution at
									// FUs through events,
