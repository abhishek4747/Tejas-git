...
public class Exchange implements InstructionHandler 
{
	public InstructionList handle(Operand operand1, Operand operand2, Operand operand3, DynamicInstruction dynamicInstruction)
	{
		...
		if((operand1.isIntegerRegisterOperand() || operand1.isMachineSpecificRegisterOperand()) &&
		   ...
		   operand3==null)
		{
			microOps.appendInstruction(Instruction.getExchangeInstruction( operand1, operand2));
			return microOps;
		}
		...
		//operand1 is a register and operand2 is also a memory operand
		        ...
		        (operand2.isMemoryOperand()) &&
		         operand3==null)
		{
			microOps.appendInstruction(Instruction.getExchangeInstruction( operand2, operand1));
			return microOps;
		}
