...
public class FloatingPointALU implements InstructionHandler 
{
	public InstructionList handle(Operand operand1, Operand operand2, Operand operand3, DynamicInstruction dynamicInstruction) 
	{
		...
		if(operand1==null && operand2==null	&& operand3==null)
		{
			...
			microOps.appendInstruction(Instruction.getFloatingPointALU(st1, st0, st0));
			return microOps;
		}
		...
		{
			Operand st0 = Registers.getTopFPRegister();
			microOps.appendInstruction(Instruction.getFloatingPointALU(operand1, st0, st0));
			return microOps;
		}
				...
				operand2==null && operand3==null)
		{
			...
			microOps.appendInstruction(Instruction.getFloatingPointALU(tempFloatRegister, st0, st0));
