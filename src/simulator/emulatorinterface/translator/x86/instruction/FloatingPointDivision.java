...
public class FloatingPointDivision implements InstructionHandler 
{
	public InstructionList handle(Operand operand1, Operand operand2, Operand operand3, DynamicInstruction dynamicInstruction) 
	{
		...
		if(operand1==null && operand2==null	&& operand3==null)
		{
			...
			microOps.appendInstruction(Instruction.getFloatingPointDivision(st0, st1, st0));
			return microOps;
		}
		...
		{
			Operand st0 = Registers.getTopFPRegister();
			microOps.appendInstruction(Instruction.getFloatingPointDivision(st0, operand1, st0));
			return microOps;
		}
				...
				operand2==null && operand3==null)
		{
			...
			microOps.appendInstruction(Instruction.getFloatingPointDivision(st0, 
