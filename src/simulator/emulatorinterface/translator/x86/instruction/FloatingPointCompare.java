...
public class FloatingPointCompare implements InstructionHandler 
{
			...
			MicroOpsList microOpsList)
	{
		...
		if(operand1==null && operand2==null && operand3==null)
		{
			...
			microOpsList.appendInstruction(Instruction.getFloatingPointALU(st0, st1, null));
		}
		...
		else if(operand1.isFloatRegisterOperand() && operand2==null && operand3==null)
		{
			...
			microOpsList.appendInstruction(Instruction.getFloatingPointALU(st0, operand1, null));
		}
		...
		else if(operand1.isFloatRegisterOperand() && operand2.isFloatRegisterOperand() && operand3==null)
		{
			...
			microOpsList.appendInstruction(Instruction.getFloatingPointALU(operand1, operand2, null));
		}
		...
		else if(operand1.isMemoryOperand() && operand2==null && operand3==null)
		{
			...
			microOpsList.appendInstruction(Instruction.getFloatingPointALU(st0, tempFloatRegister, null));
		}
